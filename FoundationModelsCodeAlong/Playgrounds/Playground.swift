...
#Playground {
    ...
    switch model.availability {
        ...
        case .unavailable(.deviceNotEligible):
            print("The model is not available on this device since device is not eligible")

        case .unavailable(.appleIntelligenceNotEnabled):
            print("Apple Intelligence is not enabled in your Settings.")

        case .unavailable(.modelNotReady):
            print("The model is not ready yet. Please try again later this is a temporary issue .")
